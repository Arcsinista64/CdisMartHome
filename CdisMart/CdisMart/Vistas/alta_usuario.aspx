        ...
        <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Error. Ingrese nombre alfabètico (Max. 50 caracteres)." ControlToValidate="txtNombreCompleto" ValidationExpression="^[a-zA-Z]+(\s*[a-zA-Z]*)*[a-zA-Z]{0,50}$" ValidationGroup="vlg1" Display="Dynamic"></asp:RegularExpressionValidator>
            ...
            <div class="form-group">
              ...
              <div class="">
                  ...
                  <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Ingrese contraseña alfanumerica (Max. 10 caracteres)." ControlToValidate="txtPassword" ValidationExpression="" ValidationGroup="vlg1" Display="Dynamic"></asp:RegularExpressionValidator>--%>
            ...
            <div class="form-group">
              ...
              <div class="">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Requerido" ControlToValidate="txtPasswordConfirmacion" ValidationGroup="vlg1"></asp:RequiredFieldValidator>--%>
